...
import accommodationsHeroBg from "@/public/images/bg-hero-accommodations.webp";
...
export default function Hero() {
  return (
    <section className="relative py-24 lg:py-32 min-h-[85vh] lg:min-h-[90vh] flex items-center justify-center text-center overflow-hidden">
      {/* Imagem de Fundo das Acomodações */}
      <div className="absolute inset-0 z-0">
        <Image
          src={accommodationsHeroBg}
          alt="Acomodações do Maré Alta Hotel"
          fill
          priority
          sizes="100vw"
      ...
      <div className="relative wrapper mx-auto px-4 sm:px-6 lg:px-8 z-10 max-w-4xl flex flex-col items-center">
        ...
        <p className="text-text-muted text-base md:text-lg font-normal max-w-2xl leading-relaxed">
          Conforto e tranquilidade planejados para sua estadia em Natal. Cada
          espaço foi desenhado para maximizar o seu descanso, unindo a brisa
          costeira à sofisticação do design contemporâneo.
        </p>
      </div>
    </section>
  );
